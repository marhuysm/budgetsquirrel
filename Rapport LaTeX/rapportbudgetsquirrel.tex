...
Le rapport ci-dessous documente le processus de design et de conception, ainsi que les développements successifs et les améliorations apportées à l'idée originale décrite dans le rapport précédent.
...
Les contraintes prévues par le schéma logique relationnel pouvant être traduites directement dans la création des tables ont été établies. Tous les attributs obligatoires sont déclarés comme non nuls, la longueur de utilisateur.niss est fixée à 11, la longueur de carte.numero\_carte est fixée entre 16 et 17.
...
Comme décrit précédemment, nous faisont appel à des \verb\CHECK\ afin de vérifier certaines des valeurs dans notre base de données.
