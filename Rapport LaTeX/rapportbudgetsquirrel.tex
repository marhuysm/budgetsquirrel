...
Ensuite, elle calcule deux sommes, en fonction de si le montant est positif ou négatif : le total des dépenses pour un type donné, et le total des revenus pour un type donné.
