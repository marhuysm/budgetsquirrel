...
Ainsi, il est possible pour l'administrateur de supprimer des utilisateur s'il le souhaite, ou encore d'en modifier des informations comme le NISS, et que ces valeurs se répercutent sur le reste de la base de données.
...
Finalement, cette vue permet de compléter la table \verb\transaction_financières\ des données supplémentaires liées aux sous-tables de type, et ce pour chaque transaction effectuée.
